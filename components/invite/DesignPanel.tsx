          ...
          <div>
            ...
            <CustomSelect
              ...
              options={[
                ...
                { id: 'anime_howl', name: '🎵 인생의 회전목마 — 하울의 움직이는 성', extra: '3/4 왈츠 · 아련하고 서정적인 웨딩 선율' },
                { id: 'anime_chihiro', name: '🎵 언제나 몇 번이라도 — 센과 치히로', extra: '3/4 · 따뜻하고 감동적인 웨딩 선율' },
                { id: 'anime_summer', name: '🎵 하루 (One Summer\'s Day) — 센과 치히로', extra: '4/4 · 맑고 잔잔한 피아노 선율' },
                { id: 'anime_laputa', name: '🎵 너를 태우고 — 천공의 성 라퓨타', extra: '4/4 · 웅장하고 영롱한 웨딩 피아노' },
                { id: 'anime_kiki', name: '🎵 바다가 보이는 마을 — 마녀 배달부 키키', extra: '4/4 · 상큼하고 로맨틱한 선율' },
                { id: 'anime_totoro', name: '🎵 이웃집 토토로 메인 테마', extra: '4/4 · 따뜻하고 포근한 웨딩 선율' },
                { id: 'anime_yourname', name: '🎵 나와 당신의 이야기 — 너의 이름은', extra: '4/4 · 감성적인 현대 애니 웨딩 선율' },
                { id: 'anime_mononoke', name: '🎵 모노노케 히메 테마', extra: '4/4 단조 · 서정적이고 신비로운 선율' },
                { id: 'anime_ponyo', name: '🎵 벼랑 위의 포뇨 테마', extra: '4/4 · 밝고 사랑스러운 선율' },
                { id: 'anime_nausicaa', name: '🎵 바람의 계곡 나우시카 테마', extra: '4/4 · 서사적이고 아름다운 오케스트라 선율' },
              ]}
              onChange={(v) => {
                const presetInfo: Record<string, { title: string; artist: string }> = {
                  'anime_howl': { title: '인생의 회전목마', artist: 'Joe Hisaishi' },
                  'anime_chihiro': { title: '언제나 몇 번이라도', artist: 'Joe Hisaishi' },
                  'anime_summer': { title: 'One Summer\'s Day (하루)', artist: 'Joe Hisaishi' },
                  'anime_laputa': { title: '너를 태우고', artist: 'Joe Hisaishi' },
                  'anime_kiki': { title: '바다가 보이는 마을', artist: 'Joe Hisaishi' },
                  'anime_totoro': { title: '이웃집 토토로', artist: 'Joe Hisaishi' },
                  'anime_yourname': { title: '나와 당신의 이야기', artist: 'RADWIMPS' },
                  'anime_mononoke': { title: '모노노케 히메', artist: 'Joe Hisaishi' },
                  'anime_ponyo': { title: '벼랑 위의 포뇨', artist: 'Joe Hisaishi' },
                  'anime_nausicaa': { title: '바람의 계곡 나우시카', artist: 'Joe Hisaishi' },
                };
